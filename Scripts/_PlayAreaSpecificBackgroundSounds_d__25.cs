using UnityEngine;
private sealed class Area01View.<PlayAreaSpecificBackgroundSounds>d__25 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public Area01View.<PlayAreaSpecificBackgroundSounds>d__25(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        label_2:
        this.<>1__state = 0;
        39413.PlayStoppableSound(clip:  this.<ambientClip>5__3, loop:  false, volume:  1f);
        UnityEngine.WaitForSeconds val_5 = null;
        val_7 = val_5;
        val_5 = new UnityEngine.WaitForSeconds(seconds:  4.5f);
        val_8 = 2;
        goto label_15;
        label_1:
        this.<>1__state = 0;
        label_11:
        39413.PlayRandomStoppableSound(clips:  this.<randomClips>5__2, loop:  false, volume:  1f);
        UnityEngine.WaitForSeconds val_6 = null;
        val_7 = val_6;
        val_6 = new UnityEngine.WaitForSeconds(seconds:  9.5f);
        val_8 = 1;
        label_15:
        val_9 = 1;
