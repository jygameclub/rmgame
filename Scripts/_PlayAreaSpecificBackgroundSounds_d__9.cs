using UnityEngine;
private sealed class Area22View.<PlayAreaSpecificBackgroundSounds>d__9 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public Area22View.<PlayAreaSpecificBackgroundSounds>d__9(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        label_2:
        this.<>1__state = 0;
        39417.PlayStoppableSound(clip:  this.<ambientClip>5__3, loop:  false, volume:  1f);
        ...
        this.<>1__state = 0;
        label_11:
        39417.PlayRandomStoppableSound(clips:  this.<randomClips>5__2, loop:  false, volume:  1f);
