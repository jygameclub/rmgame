...
private sealed class Json.Parser : IDisposable
{
    ...
    private HSMiniJSON.Json.Parser.TOKEN NextToken { get; }
    ...
    public static object Parse(string jsonString)
    {
        ...
        var val_5 = 0;
        if(mem[1152921505153101824] != null)
        {
                val_5 = val_5 + 1;
        }
        else
        {
                Json.Parser val_4 = 1152921505153064960 + ((mem[1152921505153101832]) << 4);
        }
    ...
    private object ParseByToken(HSMiniJSON.Json.Parser.TOKEN token)
    {
        var val_10 = 0;
        if((token - 1) > 9)
        {
        ...
        var val_10 = 36599728 + ((token - 1)) << 2;
        val_10 = val_10 + 36599728;
        goto (36599728 + ((token - 1)) << 2 + 36599728);
    }
    private string ParseString()
    {
        ...
        var val_14 = 36599696 + (((val_4 & 65535) - 110)) << 2;
        val_14 = val_14 + 36599696;
        goto (36599696 + (((val_4 & 65535) - 110)) << 2 + 36599696);
    }
    private object ParseNumber()
    {
        ...
        {
                bool val_4 = System.Double.TryParse(s:  val_1, result: out  double val_3 = 1.28823668567016E-231);
            val_7 = 0;
            val_8 = null;
            return (object)0;
        }
    ...
    private HSMiniJSON.Json.Parser.TOKEN get_NextToken()
    {
        var val_9;
        this.EatWhitespace();
        if(this.json == 1)
        ...
        var val_9 = 36599596;
        val_9 = (36599596 + (((val_1 & 65535) - 34)) << 2) + val_9;
        goto (36599596 + (((val_1 & 65535) - 34)) << 2 + 36599596);
        label_2:
        val_9 = 0;
        return (TOKEN)val_9;
        label_3:
