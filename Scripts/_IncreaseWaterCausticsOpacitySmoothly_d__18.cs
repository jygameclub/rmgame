using UnityEngine;
private sealed class Area22View.<IncreaseWaterCausticsOpacitySmoothly>d__18 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public Area22View.<IncreaseWaterCausticsOpacitySmoothly>d__18(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        this.<>4__this.waterCaustics.color = new UnityEngine.Color() {r = 0f, g = 0f, b = 0f, a = 0f};
        val_10 = 1;
        this.<>2__current = 0;
