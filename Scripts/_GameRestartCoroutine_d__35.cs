using UnityEngine;
private sealed class GameManager.<GameRestartCoroutine>d__35 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public GameManager.<GameRestartCoroutine>d__35(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        if((this.<>4__this.OnGameRestart) != null)
        {
                this.<>4__this.OnGameRestart.Invoke();
        }
        
        if((this.<loadingViewDisplayed>5__3) != false)
        {
                this.<>4__this.loadingManager.HideLoading(delay:  0f);
        }
        
        this.<>4__this.RestartGame();
        val_6 = 2;
        goto label_16;
        label_1:
        val_6 = 0;
        ...
        if(val_5 == 3)
        {
            ...
            val_7 = null;
            val_7 = null;
            val_9 = GameManager.<>c.<>9__35_0;
            if(val_9 == null)
        {
                System.Action val_4 = null;
            val_9 = val_4;
            val_4 = new System.Action(object:  GameManager.<>c.__il2cppRuntimeField_static_fields, method:  System.Void GameManager.<>c::<GameRestartCoroutine>b__35_0());
            GameManager.<>c.<>9__35_0 = val_9;
        }
