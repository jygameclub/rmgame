using UnityEngine;
private sealed class Area01BuildCastleView.<ShowPoolCaustics>d__7 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    private int <>1__state;
    private object <>2__current;
    public Royal.Scenes.Home.Areas.Area01.Tasks.BuildCastle.Area01BuildCastleView <>4__this;
    ...
    // Methods
    public Area01BuildCastleView.<ShowPoolCaustics>d__7(int <>1__state)
    {
