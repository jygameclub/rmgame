using UnityEngine;
private sealed class MadnessChestRewardView.<JumpSfx>d__13 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public MadnessChestRewardView.<JumpSfx>d__13(int <>1__state)
    {
