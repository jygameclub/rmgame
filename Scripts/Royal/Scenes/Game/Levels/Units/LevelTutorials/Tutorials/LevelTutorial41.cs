...
{
    public class LevelTutorial41 : ALevelTutorial
    {
        // Properties
        ...
        private void ShowStep1()
        {
            ...
            Royal.Scenes.Game.Mechanics.Board.Cell.CellPoint val_4 = new Royal.Scenes.Game.Mechanics.Board.Cell.CellPoint(x:  5, y:  1);
            val_1.Add(item:  new Royal.Scenes.Game.Mechanics.Board.Cell.CellPoint() {x = val_4.x, y = val_4.x});
            Royal.Scenes.Game.Mechanics.Board.Cell.CellPoint val_5 = new Royal.Scenes.Game.Mechanics.Board.Cell.CellPoint(x:  5, y:  5);
            ...
            Royal.Scenes.Game.Levels.Units.LevelTutorials.View.TutorialDialogView val_7 = ShowDialog();
            var val_13 = val_7;
            Royal.Scenes.Game.Levels.Units.LevelTutorials.View.TutorialDialogView val_8 = val_7.SetSize(textWidth:  7.5f, dialogWidth:  4.2f);
            Royal.Scenes.Game.Levels.Units.LevelTutorials.View.TutorialDialogView val_10 = val_13.SetText(text:  Royal.Infrastructure.Utils.String.StringExtensions.Localize(text:  "Level41Step1"));
            UnityEngine.Vector3 val_11 = this.GetGridTopCenterPos(xOffset:  0f, yOffset:  1.1f);
