...
{
    public class LevelTutorial9 : ALevelTutorial
    {
        // Properties
        ...
        private void ShowStep1()
        {
            ...
            {
                val_9 = val_9 + 1;
                Royal.Scenes.Game.Mechanics.Board.Cell.CellPoint val_2 = new Royal.Scenes.Game.Mechanics.Board.Cell.CellPoint(x:  1, y:  val_9);
            ...
            DisableTouchExceptCells(cellPoints:  val_3);
            HighlightCells(cellPoints:  val_3);
            Royal.Scenes.Game.Levels.Units.LevelTutorials.View.TutorialDialogView val_11 = ShowDialog();
            Royal.Scenes.Game.Levels.Units.LevelTutorials.View.TutorialDialogView val_6 = val_11.SetText(text:  Royal.Infrastructure.Utils.String.StringExtensions.Localize(text:  "Level9Step1"));
            UnityEngine.Vector3 val_7 = this.GetGridTopCenterPos(xOffset:  0f, yOffset:  0.6f);
