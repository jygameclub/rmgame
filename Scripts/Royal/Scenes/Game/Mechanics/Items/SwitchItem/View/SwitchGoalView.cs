...
{
    public class SwitchGoalView : MonoBehaviour, IPoolable
    {
        // Fields
        public const Royal.Scenes.Game.Mechanics.Goal.GoalType goalType = 40;
        public const float ScaleMultiplier = 1;
        ...
        private Royal.Scenes.Game.Mechanics.Items.SwitchItem.View.ISwitchableDelegate viewDelegate;
        ...
        // Methods
        public void Play(Royal.Scenes.Game.Mechanics.Items.SwitchItem.View.ISwitchableDelegate viewDelegate)
        {
        ...
        private void UpdateSorting(Royal.Scenes.Game.Mechanics.Sortings.SortingData sortingData)
        {
            ...
            Royal.Infrastructure.Utils.Sprite.SpriteExtensions.SetSorting(renderer:  this.pearl, data:  new Royal.Scenes.Game.Mechanics.Sortings.SortingData() {layer = sortingData.layer, order = sortingData.order, sortEverything = val_3});
            Royal.Scenes.Game.Mechanics.Sortings.SortingData val_1 = Royal.Scenes.Game.Mechanics.Sortings.Sorting.GetSortingWithOffset(data:  new Royal.Scenes.Game.Mechanics.Sortings.SortingData() {layer = sortingData.layer, order = sortingData.order, sortEverything = val_3}, offset:  99);
        ...
        private System.Collections.IEnumerator CurveToGoal()
        {
            .<>1__state = 0;
            .<>4__this = this;
            return (System.Collections.IEnumerator)new SwitchGoalView.<CurveToGoal>d__14();
        }
        public SwitchGoalView()
        {
