...
{
    public class CupShelfPartBR : CupShelfViewPart
    {
        // Methods
        ...
        public override void SelectSprite(bool top, bool bottom, bool left, bool right, bool topLeft, bool topRight, bool bottomLeft, bool bottomRight)
        {
            ...
            mem[1152921523764173676] = 8.48798316731955E-314;
            label_3:
            this.EnableSprites();
            return;
            label_4:
        ...
        public override void SetSorting(Royal.Scenes.Game.Mechanics.Sortings.SortingData sortingData)
        {
            ...
            mem[1152921523764285664] = sortingData.layer;
            mem[1152921523764285668] = sortingData.order;
            mem[1152921523764285672] = val_4;
