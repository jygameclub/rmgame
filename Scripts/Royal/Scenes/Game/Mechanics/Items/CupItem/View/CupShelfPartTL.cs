...
{
    public class CupShelfPartTL : CupShelfViewPart
    {
        // Fields
        ...
        public override void SetSorting(Royal.Scenes.Game.Mechanics.Sortings.SortingData sortingData)
        {
            ...
            mem[1152921523764782816] = sortingData.layer;
            mem[1152921523764782820] = sortingData.order;
            mem[1152921523764782824] = val_4;
