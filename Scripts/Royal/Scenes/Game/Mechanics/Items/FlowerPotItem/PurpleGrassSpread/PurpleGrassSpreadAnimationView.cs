...
namespace Royal.Scenes.Game.Mechanics.Items.FlowerPotItem.PurpleGrassSpread
{
    public class PurpleGrassSpreadAnimationView : MonoBehaviour, IPoolable
    {
        // Fields
        ...
        private Royal.Scenes.Game.Mechanics.Items.StaticItems.PurpleGrassItem.View.PurpleGrassItemAssets grassItemAssets;
        ...
        public Royal.Scenes.Game.Mechanics.Items.StaticItems.PurpleGrassItem.View.PurpleGrassViewData grassViewData;
        private Royal.Scenes.Game.Mechanics.Items.FlowerPotItem.View.FlowerPotItemAssets flowerPotItemAssets;
        ...
        private void Awake()
        {
            ...
            this.flowerPotItemAssets = this.itemFactory.assetsLibrary.Load<Royal.Scenes.Game.Mechanics.Items.FlowerPotItem.View.FlowerPotItemAssets>();
            this.grassItemAssets = this.itemFactory.assetsLibrary.Load<Royal.Scenes.Game.Mechanics.Items.StaticItems.PurpleGrassItem.View.PurpleGrassItemAssets>();
        }
        public void Play(UnityEngine.Vector3 startPosition, UnityEngine.Vector3 endPosition, Royal.Scenes.Game.Mechanics.Board.Cell.CellModel cellModel, DG.Tweening.Sequence seq, int xIndex, int yIndex)
        {
            ...
            val_28 = val_22;
            val_22 = new DG.Tweening.TweenCallback(object:  new PurpleGrassSpreadAnimationView.<>c__DisplayClass21_0(), method:  System.Void PurpleGrassSpreadAnimationView.<>c__DisplayClass21_0::<Play>b__0());
            ...
            this.isPlaying = true;
            Royal.Scenes.Game.Mechanics.Sortings.SortingData val_24 = Royal.Scenes.Game.Mechanics.Sortings.Sorting.GetGrassSorting(point:  new Royal.Scenes.Game.Mechanics.Board.Cell.CellPoint() {x = seq, y = seq}, layer:  1);
            var val_30 = 0;
            label_24:
        ...
        private void PlayAnimationByIndex()
        {
            ...
            val_3 = null;
            label_8:
            this.animator.Play(stateNameHash:  Royal.Scenes.Game.Mechanics.Items.FlowerPotItem.PurpleGrassSpread.PurpleGrassSpreadAnimationView.__il2cppRuntimeField_static_fields, layer:  0, normalizedTime:  0f);
        ...
        private float GetDelayForIndex()
        {
            ...
            if(this.groupNo != 1)
            {
                    return (float)val_5 + val_4 == 0 ? 1 : 0;
            }
            ...
            float val_4 = 0.06f;
            var val_1 = (this.yIndex == 1) ? 1 : 0;
            val_4 = (36597288 + this.yIndex == 1 ? 1 : 0) + val_4;
            return (float)(this.yIndex == 2) ? (val_4) : (36597288 + this.yIndex == 1 ? 1 : 0);
            label_1:
            val_4 = this.yIndex;
            val_5 = 36597288;
            goto label_4;
        ...
        {
            if(this.flowerPotItemAssets != null)
            {
                    return this.flowerPotItemAssets.GetGrassAnimationData(index:  (this.groupNo != 0) ? 1 : 0);
            }
        ...
        {
            Royal.Scenes.Game.Mechanics.Items.Config.StaticItemModel val_1 = this.cellModel.<StaticMediator>k__BackingField.GetStaticItem(itemType:  0);
            if(val_1 == null)
            {
                    return;
            }
            
            var val_2 = (((Royal.Scenes.Game.Mechanics.Items.Config.StaticItemModel.__il2cppRuntimeField_typeHierarchy + (Royal.Scenes.Game.Mechanics.Items.StaticItems.PurpleGrassItem.PurpleGrassItemModel.__il2cppRuntimeField_ + -8) == null) ? (val_1) : 0;
        }
        private void UpdatePatches()
        {
            ...
            if(val_1 != null)
            {
                    Royal.Scenes.Game.Mechanics.Items.StaticItems.PurpleGrassItem.View.PurpleGrassItemView.ArrangePatch(neighbor:  val_1, patchRenderer:  this.rightPatch, itemAssets:  this.grassItemAssets, layer:  2);
            }
            else
            {
                    this.rightPatch.enabled = false;
            ...
            if(val_2 != null)
            {
                    Royal.Scenes.Game.Mechanics.Items.StaticItems.PurpleGrassItem.View.PurpleGrassItemView.ArrangePatch(neighbor:  val_2, patchRenderer:  this.topPatch, itemAssets:  this.grassItemAssets, layer:  2);
                return;
            }
        ...
        private void CheckAnimationEnd()
        {
            ...
            this.Complete();
            this.itemFactory.Recycle<Royal.Scenes.Game.Mechanics.Items.FlowerPotItem.PurpleGrassSpread.PurpleGrassSpreadAnimationView>(go:  this);
        }
        ...
        public PurpleGrassSpreadAnimationView()
        {
        
        }
        private static PurpleGrassSpreadAnimationView()
        {
            Royal.Scenes.Game.Mechanics.Items.FlowerPotItem.PurpleGrassSpread.PurpleGrassSpreadAnimationView.InitialDelay = UnityEngine.Animator.StringToHash(name:  "Base Layer.PurpleGrassSpreadAnimation");
            Royal.Scenes.Game.Mechanics.Items.FlowerPotItem.PurpleGrassSpread.PurpleGrassSpreadAnimationView.GrassSpreadEdgeAnimation = UnityEngine.Animator.StringToHash(name:  "Base Layer.PurpleGrassSpreadEdgeAnimation");
        }
