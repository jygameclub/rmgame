...
{
    public class ContributionItemView : MonoBehaviour
    {
        // Fields
        private const float GeneralScale = 1.1;
        private const float Scale1 = 1.21;
        private const float Scale2 = 0.9801;
        private const float Scale3 = 1.14345;
        private const float Scale4 = 1.089;
        private const float Scale5 = 0.99;
        ...
        public void Show(Royal.Scenes.Game.Mechanics.Boosters.BoosterType boosterType, UnityEngine.Vector2 offset, int count)
        {
            bool val_12;
            var val_13;
            val_12 = static_value_02D63840;
            val_12 = true;
            ...
            this.shadow.transform.localPosition = new UnityEngine.Vector3() {x = Royal.Scenes.Home.Ui.Sections.Home.RewardedItem.ContributionItemView.TargetShadowPosition, y = Royal.Scenes.Home.Ui.Sections.Home.RewardedItem.ContributionItemView.TargetShadowPosition.__il2cppRuntimeField_4, z = Royal.Scenes.Home.Ui.Sections.Home.RewardedItem.ContributionItemView.TargetShadowPosition.__il2cppRuntimeField_8};
            ...
            UnityEngine.Coroutine val_11 = this.StartCoroutine(routine:  this.ShowAnimation());
        }
        public void Play()
        {
            UnityEngine.Coroutine val_2 = this.StartCoroutine(routine:  this.MoveToButton());
        }
        private System.Collections.IEnumerator ShowAnimation()
        {
            .<>4__this = this;
            return (System.Collections.IEnumerator)new ContributionItemView.<ShowAnimation>d__18(<>1__state:  0);
        }
        private System.Collections.IEnumerator MoveToButton()
        {
            .<>4__this = this;
            return (System.Collections.IEnumerator)new ContributionItemView.<MoveToButton>d__19(<>1__state:  0);
        }
        ...
        private UnityEngine.Sprite GetSpriteForBooster(Royal.Scenes.Game.Mechanics.Boosters.BoosterType boosterType)
        {
            ...
            if((boosterType - 1) <= 6)
            {
                    UnityEngine.Sprite val_2 = UnityEngine.Resources.Load<UnityEngine.Sprite>(path:  45230688 + ((boosterType - 1)) << 3);
        ...
        private UnityEngine.Sprite GetShadowForBooster(Royal.Scenes.Game.Mechanics.Boosters.BoosterType boosterType)
        {
            ...
            if((boosterType - 1) <= 6)
            {
                    UnityEngine.Sprite val_2 = UnityEngine.Resources.Load<UnityEngine.Sprite>(path:  45230752 + ((boosterType - 1)) << 3);
                return (UnityEngine.Sprite)val_3;
            }
        ...
        private static ContributionItemView()
        {
            Royal.Scenes.Home.Ui.Sections.Home.RewardedItem.ContributionItemView.TargetShadowPosition = 0;
            Royal.Scenes.Home.Ui.Sections.Home.RewardedItem.ContributionItemView.TargetShadowPosition.__il2cppRuntimeField_8 = 0;
            Royal.Scenes.Home.Ui.Sections.Home.RewardedItem.ContributionItemView.Duration = 0.5f;
        }
