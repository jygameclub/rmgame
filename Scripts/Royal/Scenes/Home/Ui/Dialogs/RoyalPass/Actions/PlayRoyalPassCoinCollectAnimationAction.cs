...
{
    public class PlayRoyalPassCoinCollectAnimationAction : PlayCoinCollectAnimationAction
    {
        // Fields
        ...
        // Methods
        public PlayRoyalPassCoinCollectAnimationAction(float delay, Royal.Player.Context.Data.Session.BeforeAfterData beforeAfterData)
        {
        ...
        {
            var val_14;
            mem[1152921519304999688] = 1075838976;
            if(this.beforeAfterData.shouldConsume != false)
            {
                ...
                mem[1152921519304999692] = 1152921505056579584;
