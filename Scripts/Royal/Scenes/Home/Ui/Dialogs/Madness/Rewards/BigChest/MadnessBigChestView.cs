...
namespace Royal.Scenes.Home.Ui.Dialogs.Madness.Rewards.BigChest
{
    public class MadnessBigChestView : MadnessChestRewardView
    {
        // Fields
        ...
        public override void SetPackage(Royal.Player.Context.Data.InventoryPackage inventoryPackage)
        {
            ...
            this.hammer.SetAmount(amount:  inventoryPackage.GetBoosterCount(boosterType:  4));
            this.arrow.SetAmount(amount:  inventoryPackage.GetBoosterCount(boosterType:  5));
            this.cannon.SetAmount(amount:  inventoryPackage.GetBoosterCount(boosterType:  6));
            this.jester.SetAmount(amount:  inventoryPackage.GetBoosterCount(boosterType:  7));
        }
