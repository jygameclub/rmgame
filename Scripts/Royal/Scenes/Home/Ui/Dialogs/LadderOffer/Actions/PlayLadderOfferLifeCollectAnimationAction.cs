...
{
    public class PlayLadderOfferLifeCollectAnimationAction : FlowAction
    {
        // Fields
        ...
        // Methods
        public PlayLadderOfferLifeCollectAnimationAction(float delay, int minutes, int lifeCount = 0)
        {
            var val_2;
        ...
        private System.Collections.IEnumerator CompleteAfterDelay()
        {
            .<>1__state = 0;
            .<>4__this = this;
            return (System.Collections.IEnumerator)new PlayLadderOfferLifeCollectAnimationAction.<CompleteAfterDelay>d__4();
        }
