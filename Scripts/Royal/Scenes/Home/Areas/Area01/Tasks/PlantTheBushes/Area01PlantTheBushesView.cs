...
namespace Royal.Scenes.Home.Areas.Area01.Tasks.PlantTheBushes
{
    public class Area01PlantTheBushesView : AreaTaskViewAnimation
    {
        // Fields
        ...
        public Area01PlantTheBushesView()
        {
