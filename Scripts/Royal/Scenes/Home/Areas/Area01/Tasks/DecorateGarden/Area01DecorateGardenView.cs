...
namespace Royal.Scenes.Home.Areas.Area01.Tasks.DecorateGarden
{
    public class Area01DecorateGardenView : AreaTaskViewAnimation
    {
        // Fields
        ...
        public Area01DecorateGardenView()
        {
