...
{
    public class LocalScaleProcedure : AbstractTweenProcedure<UnityEngine.Vector3>
    {
        // Methods
        public LocalScaleProcedure(Royal.Infrastructure.Utils.Animation.Tween.MTween<UnityEngine.Vector3> mTween)
        {
        ...
        public override void Apply(UnityEngine.Vector3 startValue, UnityEngine.Vector3 endValue, float ratio)
        {
            ...
            16824064.localScale = new UnityEngine.Vector3() {x = val_1.x, y = val_1.y, z = val_1.z};
        }
