...
namespace Royal.Infrastructure.Services.Backend.Http.Command.KingsCup
{
    ...
    {
        // Fields
        private Royal.Infrastructure.Services.Backend.Protocol.ClaimKingsCupRewardResponse <Response>k__BackingField;
        ...
        public Royal.Infrastructure.Services.Backend.Protocol.ClaimKingsCupRewardResponse Response { get; set; }
        ...
        public Royal.Infrastructure.Services.Backend.Protocol.ClaimKingsCupRewardResponse get_Response()
        {
            return new Royal.Infrastructure.Services.Backend.Protocol.ClaimKingsCupRewardResponse() {__p = new FlatBuffers.Table() {bb_pos = this.<Response>k__BackingField}};
        }
        public void set_Response(Royal.Infrastructure.Services.Backend.Protocol.ClaimKingsCupRewardResponse value)
        {
            this.<Response>k__BackingField = value;
            mem[1152921528665720208] = value.__p.bb;
        }
        ...
        public override int Build(FlatBuffers.FlatBufferBuilder builder)
        {
            ...
            FlatBuffers.Offset<Royal.Infrastructure.Services.Backend.Protocol.ClaimKingsCupRewardRequest> val_3 = Royal.Infrastructure.Services.Backend.Protocol.ClaimKingsCupRewardRequest.CreateClaimKingsCupRewardRequest(builder:  builder, group_id:  this.groupId, current_user_inventoryOffset:  new FlatBuffers.Offset<Royal.Infrastructure.Services.Backend.Protocol.CurrentUserInventory>() {Value = val_1.Value & 4294967295});
        ...
        {
            var val_5;
            Royal.Infrastructure.Services.Backend.Protocol.ClaimKingsCupRewardResponse val_1 = this.ParseResponse<Royal.Infrastructure.Services.Backend.Protocol.ClaimKingsCupRewardResponse>(package:  new Royal.Infrastructure.Services.Backend.Protocol.ResponsePackage() {__p = new FlatBuffers.Table() {bb_pos = package.__p.bb_pos, bb = package.__p.bb}}, index:  index);
            this.<Response>k__BackingField = val_1;
            mem[1152921528666077712] = val_1.__p.bb;
            mem[1152921528666077696] = (( & 255) != 0) ? 1 : 0;
            ...
            val_5 = mem[public static T[] System.Array::Empty<System.Object>().__il2cppRuntimeField_30 + 302];
            val_5 = public static T[] System.Array::Empty<System.Object>().__il2cppRuntimeField_30 + 302;
            Royal.Infrastructure.Services.Logs.Log.Debug(callerClass:  this, logTag:  24, log:  "Claim status: "("Claim status: ") +, values:  public static T[] System.Array::Empty<System.Object>().__il2cppRuntimeField_30 + 184);
            if(176 == 1)
            {
                    return;
            }
            
            Royal.Player.Context.UserContext.Get<Royal.Player.Context.Units.KingsCupManager>(id:  7).ClaimKingsCup(syncId:  -1710585152, response:  new Royal.Infrastructure.Services.Backend.Protocol.ClaimKingsCupRewardResponse() {__p = new FlatBuffers.Table() {bb_pos = this.<Response>k__BackingField, bb = public static T[] System.Array::Empty<System.Object>().__il2cppRuntimeField_30 + 184}});
        }
        public override void PackageFail()
        {
            Royal.Player.Context.UserContext.Get<Royal.Player.Context.Units.KingsCupManager>(id:  7).ClaimNotFinished(claimGroupId:  this.groupId);
        }
